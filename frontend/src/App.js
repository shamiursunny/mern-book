...
// Use environment variable (better than hardcoding)
...
function App() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <h2>Auth</h2>
      <input name="name" placeholder="Name" onChange={handleAuthChange} />
      <input name="email" placeholder="Email" onChange={handleAuthChange} />
      <input name="password" placeholder="Password" onChange={handleAuthChange} />
